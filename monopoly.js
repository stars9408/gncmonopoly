...
function setup() {
	...
	$("#board, #moneybar, #banner, #logo, #rules").show();
	$("#setup").hide();
	$("#title").hide();
	
	document.getElementsByClassName('stars')[0].style.visibility = 'hidden';
	document.getElementsByClassName('twinkling')[0].style.visibility = 'hidden';
	document.getElementsByClassName('clouds')[0].style.visibility = 'hidden';
